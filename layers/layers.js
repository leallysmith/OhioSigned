...
var lyr_SignedParcelslastupdated21224_14 = new ol.layer.Vector({
                ...
                interactive: false,
                title: '<img src="styles/legend/SignedParcelslastupdated21224_14.png" /> Signed Parcels (last updated 3/20/24)'
            });
...
var lyr_SignedParcelNameslastupdated21224_15 = new ol.layer.Vector({
                ...
                interactive: true,
                title: '<img src="styles/legend/SignedParcelNameslastupdated21224_15.png" /> Signed Parcel Names (last updated 3/20/24)'
            });
...
lyr_ElectricCertifiedTerritories_10.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'EL_BoundaryID': 'EL_BoundaryID', 'EL_CompanyID': 'EL_CompanyID', 'CreateUser': 'CreateUser', 'CreateDate': 'CreateDate', 'EditUser': 'EditUser', 'EditDate': 'EditDate', 'Shape.STArea()': 'Shape.STArea()', 'Shape.STLength()': 'Shape.STLength()', });
...
lyr_ElectricCertifiedTerritories_10.set('fieldImages', {'OBJECTID': '', 'EL_BoundaryID': '', 'EL_CompanyID': 'ValueMap', 'CreateUser': '', 'CreateDate': '', 'EditUser': '', 'EditDate': '', 'Shape.STArea()': '', 'Shape.STLength()': '', });
...
lyr_ElectricCertifiedTerritories_10.set('fieldLabels', {'OBJECTID': 'no label', 'EL_BoundaryID': 'no label', 'EL_CompanyID': 'no label', 'CreateUser': 'no label', 'CreateDate': 'no label', 'EditUser': 'no label', 'EditDate': 'no label', 'Shape.STArea()': 'no label', 'Shape.STLength()': 'no label', });
lyr_Ohio_11.set('fieldLabels', {'STATE': 'header label - visible with data', 'NAME': 'header label - visible with data', 'FIPS': 'header label - visible with data', 'LON': 'header label - visible with data', 'LAT': 'header label - visible with data', });
lyr_OhioCounties_12.set('fieldLabels', {'STATEFP': 'hidden field', 'COUNTYFP': 'hidden field', 'COUNTYNS': 'hidden field', 'GEOID': 'hidden field', 'NAME': 'header label - visible with data', 'NAMELSAD': 'hidden field', 'LSAD': 'hidden field', 'CLASSFP': 'hidden field', 'MTFCC': 'hidden field', 'CSAFP': 'hidden field', 'CBSAFP': 'hidden field', 'METDIVFP': 'hidden field', 'FUNCSTAT': 'hidden field', 'ALAND': 'hidden field', 'AWATER': 'hidden field', 'INTPTLAT': 'hidden field', 'INTPTLON': 'hidden field', });
lyr_OhioCountyNames_13.set('fieldLabels', {'STATEFP': 'hidden field', 'COUNTYFP': 'hidden field', 'COUNTYNS': 'hidden field', 'GEOID': 'hidden field', 'NAME': 'header label - visible with data', 'NAMELSAD': 'hidden field', 'LSAD': 'hidden field', 'CLASSFP': 'hidden field', 'MTFCC': 'hidden field', 'CSAFP': 'hidden field', 'CBSAFP': 'hidden field', 'METDIVFP': 'hidden field', 'FUNCSTAT': 'hidden field', 'ALAND': 'hidden field', 'AWATER': 'hidden field', 'INTPTLAT': 'hidden field', 'INTPTLON': 'hidden field', });
lyr_SignedParcelslastupdated21224_14.set('fieldLabels', {'Opportunity Name': 'header label - visible with data', 'Account Name': 'header label - visible with data', 'Lease Area (Acres or Square Feet)': 'header label - visible with data', 'AO Link': 'header label - visible with data', 'Site Lat/Long Coordinates (Latitude)': 'header label - visible with data', 'Site Lat/Long Coordinates (Longitude)': 'header label - visible with data', 'Market': 'header label - visible with data', 'Utility': 'header label - visible with data', });
